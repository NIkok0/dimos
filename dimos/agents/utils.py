...
def pretty_print_langchain_message(msg: BaseMessage) -> None:
    ...
    _log_message(msg_type, content, tool_calls, msg)


def _log_message(msg_type: str, content: object, tool_calls: list[dict[str, Any]], msg: BaseMessage | None = None) -> None:
    ...
    if msg and hasattr(msg, "additional_kwargs"):
        ...
        if reasoning:
            kw["has_reasoning"] = True
            kw["reasoning_preview"] = str(reasoning)[:200]
        else:
            kw["has_reasoning"] = False
